...
public class ReusableMethods {
    ...
    //İframe Geçiş
    //  Driver.getDriver().switchTo().frame(8); --> index='dan başlar
    //  Driver.getDriver().findElement(By.xpath("//div[@id='dismiss-button']")).click(); -->handle etmek istediğim elementin locate'i
    //  Driver.getDriver().switchTo().defaultContent(); --> tekrar ana sayfaya geçiş
}
